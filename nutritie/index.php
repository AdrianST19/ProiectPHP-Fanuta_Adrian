...
<h3>Fanuta Adrian Stefan-CRUD Fitness Gym</h3>
  <h5>Mai jos puteti crea, citi, modifica sau sterge date din tabela ce contine programe de nutritie:</h5>

<button class="accordion">Sectiunea Programe de Nutritie</button>
<div class="panel">
