...
<h3>Fanuta Adrian Stefan-CRUD Fitness Gym</h3>
  <p>Mai jos puteti modifica campurile ce contin datele ehipamentului:</p>
  Nume:<input type="text" name="name" value="<?= $foundTodo['name']; ?>">
  Pret:<input type="number" min="0" max="1000000" name="pret" value="<?= $foundTodo['pret']; ?>">
  Furnizor:<br><input type="text" name="furnizor" value="<?= $foundTodo['furnizor']; ?>">
