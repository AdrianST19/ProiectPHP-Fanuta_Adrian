...
<h3>Fanuta Adrian Stefan-CRUD Fitness Gym</h3>
  <p>Mai jos puteti modifica campurile ce contin datele antrenorului:</p>
  ...
  Numarul de clienti antrenati (maxim 10):<br><input type="number" min="0" max="10" name="clienti" value="<?= $foundTodo['clienti']; ?>">
